 ...
 * @author Enaium
 */
public class Vec4Conf<T extends Number> extends Conf<Vec4<T>> {

    private final Range<T> xRange;
    private final Range<T> yRange;
    private final Range<T> zRange;
    private final Range<T> wRange;

    public Vec4Conf(String id, String name, String description, Widget widget, Range<T> xRange, Range<T> yRange, Range<T> zRange, Range<T> wRange) {
