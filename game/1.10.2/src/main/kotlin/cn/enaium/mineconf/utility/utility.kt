...
fun Style.toMinecraft(): net.minecraft.text.Style {
    return net.minecraft.text.Style().apply {
        ...
        this@toMinecraft.hover?.also {
            this.hoverEvent = HoverEvent(HoverEvent.Action.valueOf(it.action.name), it.value.toMinecraft())
        }
        this@toMinecraft.click?.also {
            this.clickEvent = ClickEvent(ClickEvent.Action.valueOf(it.action.name), it.value)
        }
    }
}